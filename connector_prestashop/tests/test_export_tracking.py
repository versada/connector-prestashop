...
class TestExportPicking(PrestashopTransactionCase):
    ...
    def test_01_event_tracking_number__not_prestashop_sale(self):
    ...
    @assert_no_job_delayed
    def test_02_event_tracking_number__prestashop_sale(self):
    ...
    @assert_no_job_delayed
    def test_03_export_tracking_number(self):
