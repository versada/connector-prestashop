...
class TestImportPartner(PrestashopTransactionCase):
    ...
    def test_01_import_partner_since(self):
    ...
    @freeze_time("2016-09-13 00:00:00")
    @assert_no_job_delayed
    def test_02_import_partner_batch(self):
    ...
    @assert_no_job_delayed
    def test_03_import_partner_category_record(self):
    ...
    @assert_no_job_delayed
    def test_04_import_partner_record(self):
        """Import a partner"""
    ...
    @assert_no_job_delayed
    def test_05_import_partner_address_batch(self):
        delay_record_path = "odoo.addons.queue_job.models.base.DelayableRecordset"
        # execute the batch job directly and replace the record import
        # by a mock (individual import is tested elsewhere)
    ...
    @assert_no_job_delayed
    def test_06_import_partner_address_record(self):
